...
% ========
  ...
  % ========
    ...
    A wave function for pair of spin-1/2 fermions (Eq.~\ref{eq:pp-wf}) is a superposition of two possible states: singlet state (with spin equal to 0 and one state) and triplet state (with spin equal to 1 and three possible eigenstates).
    For a singlet state, a wave function is symmetric, and for triplet state, it is antisymmetric.
    Therefore, the coefficient before cosine in the $|\Psi_{pp}|^2$ is equal to \mbox{$(-1) \times 3/4 + 1 \times 1/4 = -1/2$}.
