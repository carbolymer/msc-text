...
% ========
  ...
  % ========
    ...
    % ========
      ...
      % - intro cd wzor gauss 3d z Rinv (A3 NonidFemto) @ PRF
      % - jakobian
      % - equal time approx - DOPISAC DO FUNKCJI FALOWEJ Z APPENDIX A NONIDFEMTO
      % - dopisac do konwencji equal time approx!!!
      % - wzor 1d z Rinv @ PRF
