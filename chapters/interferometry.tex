...
% ========
  ...
  % ========
    ...
    % ========
      ...
      The analysis carried out in this work uses data from a model, therefore the detector efficiency and particle purity is not taken into account.
    %
    % ========
    ...
    % ========
      ...
      Doing that, one may loose important information about a correlation function, because this is only a limited view of the full three-dimensional structure.
