...
% ========
  ...
  % ========
    ...
    \begin{description}
      \item[skynet.sh] This is a script in a form of a batch job for TORQUE.
        ...
        Thus, in case of running 20 instances of generator, it makes significant difference.
      ...
      \item[merge\_events.sh] After the generation process, one has to merge calculated events into one directory.
        ...
        This command will find all the event files in the directory \verb|/data/source|, move and rename those files accordingly to the numeration of events in the current working directory.
    \end{description}
  ...
  % ========
    ...
    The application provides functionality of calculation of one-dimensional correlation functions in PRF, three-dimensional one in LCMS and its spherical harmonics decomposition (see Section~\ref{sec:sh}).
