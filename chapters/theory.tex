...
\chapter{Theory of heavy ion collisions}
  ...
  % ========
    ...
    % ========
      ...
      The quark-gluon plasma is very short living and unstable state of matter.
      One cannot confirm existence of it and investigate the properties of a plasma directly.
      Several experimental effects were proposed as QGP signatures, some of them have been already observed in heavy ion experiments~\cite{drkisiel}.
      As matter created in the heavy ions collisions is supposed to behave like a fluid, one should expect appearance of collective behaviour at small transversive momenta - so called \textit{radial flow} and \textit{elliptic flow}.
      % \subsubsection{Kinematic variables} %subsection?
      %AK
      \subsubsection{Elliptic flow}
        In a non-central heavy ion collisions, created region of matter has an almond shape (Fig.~\ref{fig:elliptic_flow}).
        
        \begin{figure}[h]
          \centering
          \includegraphics[width=0.6\textwidth]{elliptic_flow}
          \caption{Overlapping region which is created in heavy ion collisions has an almond shape.~\cite{eflow}}
