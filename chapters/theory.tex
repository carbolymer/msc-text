...
\chapter{Theory of heavy ion collisions}
  ...
  % QGP signatures?
    ...
    % ========
      ...
      As two quarks are pulled apart, the distance and the potential grow.
      ...
      For the small distances, an interaction between the quarks and gluons is weakening and they are starting to behave like free particles.
    ...
    % ========
      The new state of matter in which quarks are no longer confined is know as \textit{quark-gluon plasma} (QGP).
      ...
      Such increase is signaling of a phase transition - the formation of QGP~\cite{drkisiel}.
