...
\chapter{Theory of heavy ion collisions}
  ...
  % ========
    ...
    % ========
      ...
      One cannot investigate the properties of a plasma and confirm existence of it directly.
      ...
      \subsubsection{Transverse radial flow}
        ...
        \begin{figure}[h]
          ...
          \caption{Invariant yield of particles versus transverse mass $m_T = \sqrt{p^2_T + m_0^2}$ for $\pi^{\pm}$, $K^{\pm}$, $p$ and $\bar{p}$ at mid-rapidity for pp collisions (bottom) and Au+Au events from 70-80\% (second bottom) to 0-5\% (top) centrality~\cite{mtspectra}.}
