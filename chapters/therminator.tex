...
\chapter{Therminator model}
  ...
  % ========
    ...
    % ========
      ...
      The equations presented above are directly used in the \verb|THERMINATOR| to generate the primordial hadrons (created during freeze-out) with the Monte-Carlo method.
