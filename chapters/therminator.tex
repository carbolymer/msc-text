...
\chapter{Therminator model}
  ...
  % ========
    ...
    One of the crucial elements of the statistical approach is the complete inclusion of hadronic resonances.
    This is because at the rather high temperature of the freeze-out $\approx$140-160 MeV, the resonances contribute very significantly to the observables~\cite{therminator}.
    %
    % ========
    ...
    % ========
      ...
      The thermodynamic quantities in $f(\cdot)$ are $T$ - temperature, $\mu_B$ - baryon chemical potential, $\mu_{I_3}$ - isospin chemical potential, $\mu_S$ - strange chemical potential, $\mu_C$ - charmed chemical potential and the $s$ is a spin of a particle.
